...
from pdf2gtfs.reader import (
    preprocess_check, dataframe_to_rows, get_chars_dataframe, get_pages,
    Reader, sniff_page_count)

from test import P2GTestCase, TEST_DATA_DIR
...
class Test(P2GTestCase):
    ...
    def test_sniff_page_count(self) -> None:
        ...
        file_path = TEST_DATA_DIR.joinpath("rmv_u1.pdf")
    ...
    def test__preprocess_check(self) -> None:
        ...
        self.assertFalse(preprocess_check())
        Config.preprocess = True
        self.assertTrue(preprocess_check())
